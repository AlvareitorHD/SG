...
import { Cubo, Cono, Cilindro, Esfera, Toro, Icosaedro } from './Geometrias.js'
...
class MyScene extends THREE.Scene {
  ...
  constructor (myCanvas) { 
    ...
    this.box = new Cubo(this.gui, "Controles CUBO");
    this.add (this.box);
    this.cone = new Cono(this.gui, "Controles CONO");
    this.add(this.cone);
    this.cilinder = new Cilindro(this.gui, "Controles Cilindro");
    this.add(this.cilinder);
    this.sphere = new Esfera(this.gui,"Controles ESFERA");
    this.add(this.sphere);
    this.torus = new Toro(this.gui,"Controles TORO");
    this.add(this.torus);
    this.ico = new Icosaedro(this.gui,"Controles ICOSAEDRO");
    this.add(this.ico);
  }
