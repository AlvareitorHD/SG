...
class Circuito extends THREE.Object3D {
  constructor(gui, titleGui) {
    ...
    // Supongamos que tienes un archivo OBJ almacenado en la variable 'objData' como una cadena de texto
var objData = ; // Aquí iría el contenido del archivo OBJ

// Array para almacenar los vértices extraídos
var vertices = [];
...
lines.forEach(function(line) {
    ...
    // Verificar si la línea define un vértice (comienza con 'v')
    if (parts[0] === 'v') {
        // Extraer las coordenadas x, y, z y crear un nuevo vértice
...
// Ahora 'vertices' contiene todos los puntos extraídos del archivo OBJ
